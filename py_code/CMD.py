...
from get_motion_history_New import get_motion_history

#!! 需要注释下面来传递参数
startstr = '2021-12-14-00-00-00'
endstr = '2021-12-25-20-59-59'
datatype = 'UUID'  # Motion | UUID  #选择要采的数据类型
...
# locations = ["733830", "447223", "480089", "290596", "318476"]  # 金牌
locations = ["674889", "702519", "157170"]  # adw
